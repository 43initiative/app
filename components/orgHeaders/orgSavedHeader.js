...
class OrgSavedHeader extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Animated.View style={[{width:'100%',marginLeft:'0%',paddingLeft:'5%',paddingRight:'5%',height:dimensions.returnHeight(.08),backgroundColor:'white'},flexing.rowBetween]}>
                <View style={[flexing.rowStart,{width:'50%'}]}>
                    <Text style={[{color:'#101010',fontStyle:'normal',fontWeight:'bold',fontSize:25}]}>Saved Inspo</Text>
...
export default connect(mapStateToProps,mapDispatchToProps)(OrgSavedHeader)
