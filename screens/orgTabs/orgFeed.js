...
import {updateOrgLikedList, returnOrgFollowingList,returnOrgFollowerList, updateOrgSavedList, returnOrgSavedList, returnOrgLikedList, getAllDeeds} from "../../firebase/fireStarter";
...
import {CollapsibleHeaderFlatList} from "react-native-collapsible-header-views";
  ...
  export default class OrgFeed extends React.Component {
    constructor(props) {
        super(props);
    ...
    getFollowStats = async () => {
        let followers = await returnOrgFollowerList();
        let following = await returnOrgFollowingList();
    ...
    getAllDeeds = async () => {
        ...
        let likedList = await returnOrgLikedList();
        let savedList = await returnOrgSavedList();
    ...
    likePost = async (postId,i) => {
        ...
        this.setState({likedList:[...likedList]},async()=>{
            await updateOrgLikedList(likedList);
        })
    ...
    unlikePost = async  (postId) => {
      ...
      savePost = async (postId,i) => {
          ...
          this.setState({savedList:[...savedList]},async()=>{
              await updateOrgSavedList(savedList);
          })
