...
import {updateOrgLikedList, getOrgInspiration, returnOrgSavedList,returnOrgLikedList, updateOrgSavedList, getAllDeeds} from "../../firebase/fireStarter";
...
export default class OrgInspo extends React.Component {
    constructor(props) {
        super(props);
    ...
    getAllDeeds = async () => {
        let response = await getOrgInspiration();
