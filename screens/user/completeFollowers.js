...
import {getFollowers, updateFollowingList, returnUserFollowingList, getAllUsers, getFollowing} from "../../firebase/fireStarter";
import Spacer from "../../design/spacer";
import UserTruncated from "../../components/listings/userTruncated";


export default class CompleteFollowers extends React.Component {
    constructor(props) {
        super(props);
    ...
    retrieveFollowing = async () => {
        ...
        let fetchFollowers = await getFollowers(data.isSelf,data.userUid)
    ...
    getUsers = async () => {
        ...
        this.setState({list:users,followingList});
                ...
                <Animated.View style={[{backgroundColor:'white',height:'100%',width:'100%',position:'relative'}]}>
                    <View style={[{top:0,left:0,width:'90%',marginLeft:'5%',height:'10%',backgroundColor:'white'},flexing.rowBetween]}>
                        ...
                        <TextInput
                            ...
                            placeholder={`Search ${displayName}'s followers`}
